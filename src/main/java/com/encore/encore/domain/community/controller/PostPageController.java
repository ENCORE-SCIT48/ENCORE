...
//                ? performerPostService.listPosts(pageRequest)
//                : performerPostService.listPostsByType(postType, pageRequest);
//
...
//
//        model.addAttribute("post", performerPostService.readPost(postId));
//
...
//            @PathVariable(name = "postId") Long postId,
//            Model model) {
//        log.info("게시글 수정 화면 요청 - postId={}", postId);
//
//        model.addAttribute("post", performerPostService.readPost(postId));
//
